...
-- as NVD lookup cache. Pre-existing rows predate this distinction and cannot
-- be reliably reclassified, so they are all marked saved = 1 — users see
-- what they saw before and can delete strays.
