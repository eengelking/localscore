...
**docs/SPEC02.md v1.1 progress**: §7.1 (saved-vs-cache double-entry fix) and §2/§3 (design-system foundation: semantic buttons/icons/confirmation modal, light/dark theme toggle) are done — see "Design system" under Frontend below. Still open: §4 markdown descriptions, §6.2/§6.4/§6.5 Scoring page tabs/offline/Major-CVEs, §7.2/§7.3/§7.4 saved-vulnerability editing/NVD-carry-through/result presentation, §8 environments edit view.
